...
class Stats:
    ...
    def stats_row(self, row_number, default_row_x, default_row_y, default_block_width, default_block_height):
        if self.gui_stats_instance == None:#create row
            ...
            self.gui_stats_instance.csv_row = row
...
while is_running:
    ...
    if timer >= (tick_rate * refresh_time):
        ...
        print("\n -------------------------------------------------- \n")
        print("On Contact: " + str(stats_on_contact.amount))
        print("Available: " + str(stats_available.amount))
        print("On Break: " + str(stats_offline.amount))
        print("Other: " + str(stats_other.amount))
        print("Offline: " + str(stats_offline.amount))
